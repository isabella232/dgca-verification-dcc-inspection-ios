...
public class ZipManager {
    ...
    public func prepareZipData(_ cert: HCert, completionHandler: @escaping (Result<URL, Error>) -> Void) {
        do {
    ...
    private func generatePayloadBase64(_ certificate: HCert) throws {
        do {
            try writeDataToFile(data: certificate.fullPayloadString.data(using:.utf8)!.base64EncodedData(options: .endLineWithLineFeed),
            filename: "payload.base64")
        } catch {
            throw error
        }
    }
