...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "JsonLogic", url: "https://github.com/eu-digital-green-certificates/json-logic-swift.git", .branch("feature/fix-date-formatter")), //from: "1.2.2"),
        ...
        .package(name: "CertLogic", url: "https://github.com/eu-digital-green-certificates/dgc-certlogic-ios",  .branch("feature/fixed-date-formatter")), //from: "1.3.1"),
